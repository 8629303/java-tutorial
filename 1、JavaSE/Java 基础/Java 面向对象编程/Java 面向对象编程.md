...
![image.png](Java 面向对象编程.assets/0cc4abedae6a4864ab49a420ab9d036d.png)

如果此时一个项目有上千个接口，就要搭配有上千个工厂类。对开发者而言，是非常绝望的一件事。当然也可以考虑写进一个工厂类里。

![image.png](Java 面向对象编程.assets/a447af048d374856a3bae7f1dfe9b0c1.png)
...
![img](Java 面向对象编程.assets/6dd51b4ea31f4bd3a56cd706f14fdf99.png)
...
![img](Java 面向对象编程.assets/128bbcdd04bd46d6bd196c910937e9ee.png)
