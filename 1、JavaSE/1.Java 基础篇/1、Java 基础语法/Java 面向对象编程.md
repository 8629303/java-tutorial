...
![20211122104807](Java 面向对象编程.assets/image-20241025145539152.png)

清楚了以上的对应关系后，那么下面就针对于之前的程序进行分析。对于Person per = new Person();per.name = “张三” ;和per.age = 18;的内存分析如下：

![20211122104622](Java 面向对象编程.assets/image-20241025145539153.png)
...
![20211122104845](Java 面向对象编程.assets/image-20241025145539154.png)
...
![20211122105050](Java 面向对象编程.assets/image-20241025145539155.png)
...
![20211122105131](Java 面向对象编程.assets/image-20241025145539156.png)
...
![20211122105233](Java 面向对象编程.assets/image-20241025145539157.png)
...
![20211122175916](Java 面向对象编程.assets/image-20241025145539158.png)
...
![20211122224958](Java 面向对象编程.assets/image-20241025145539159.png)
...
![20211123095937](Java 面向对象编程.assets/image-20241025145539160.png)
...
![20211123100720](Java 面向对象编程.assets/image-20241025145539161.png)
...
![20211123115731](Java 面向对象编程.assets/image-20241025145539162.png)
...
![20211123120016](Java 面向对象编程.assets/image-20241025145539163.png)
...
![20211123173829](Java 面向对象编程.assets/image-20241025145539164.png)
...
![20211123174153](Java 面向对象编程.assets/image-20241025145539165.png)
...
![20211123174325](Java 面向对象编程.assets/image-20241025145539166.png)
...
![20211123214511](Java 面向对象编程.assets/image-20241025145539167.png)
...
![20211123215106](Java 面向对象编程.assets/image-20241025145539168.png)
...
![20211123215330](Java 面向对象编程.assets/image-20241025145539169.png)



**做法二：**在一个数组上进行转置（部分数据为例）

![20211123215410](Java 面向对象编程.assets/image-20241025145539170.png)
...
![20211123221619](Java 面向对象编程.assets/image-20241025145539171.png)
...
![20211125150936](Java 面向对象编程.assets/image-20241025145539172.png)
...
![20211125151610](Java 面向对象编程.assets/image-20241025145539173.png)
...
![20211125152512](Java 面向对象编程.assets/image-20241025145539174.png)
...
![20211125152724](Java 面向对象编程.assets/image-20241025145539175.png)
...
![20211125191252](Java 面向对象编程.assets/image-20241025145539176.png)

在模块之中会包含有大量的程序开发包（点击java.base模块进去）：

![20211125195715](Java 面向对象编程.assets/image-20241025145539177.png)
...
>
> ![20211125152010](Java 面向对象编程.assets/image-20241025145539178.png)
>
...
![20211125155426](Java 面向对象编程.assets/image-20241025145539179.png)
...
![20211125161941](Java 面向对象编程.assets/image-20241025145539180.png)
...
![20211125162359](Java 面向对象编程.assets/image-20241025145539181.png)
...
![20211125162953](Java 面向对象编程.assets/image-20241025145539182.png)
...
![20211125163445](Java 面向对象编程.assets/image-20241025145539183.png)
...
![20211125163934](Java 面向对象编程.assets/image-20241025145539184.png)
...
![20211125164750](Java 面向对象编程.assets/image-20241025145539185.png)
...
![20211125171548](Java 面向对象编程.assets/image-20241025145539186.png)
...
![20211125174018](Java 面向对象编程.assets/image-20241025145539187.png)
...
![20211126114803](Java 面向对象编程.assets/image-20241025145539188.png)
...
![20211126115034](Java 面向对象编程.assets/image-20241025145539189.png)
...
![20211127181935](Java 面向对象编程.assets/image-20241025145539190.png)
...
![image-20211128200253855](Java 面向对象编程.assets/image-20241025145539191.png)
...
![20211128201202](Java 面向对象编程.assets/image-20241025145539192.png)
...
![20211128223933](Java 面向对象编程.assets/image-20241025145539193.png)
...
![20211128233651](Java 面向对象编程.assets/image-20241025145539194.png)

一直在强调该操作是属于结构设计不当的结果，那么在最初的时候任何人都不敢保证你的接口设计的足够完善，所以在这样的情况下为了方便子类的修改，往往不会让子类直接继承实现接口，而是中间追加一个过渡的抽象类。

![20211128233831](Java 面向对象编程.assets/image-20241025145539195.png)
...
![20211129211942](Java 面向对象编程.assets/image-20241025145539196.png)
...
![20211129212915](Java 面向对象编程.assets/image-20241025145539197.png)
...
![20211129220032](Java 面向对象编程.assets/image-20241025145539198.png)
...
![20211129220156](Java 面向对象编程.assets/image-20241025145539199.png)
...
![20211129221925](Java 面向对象编程.assets/image-20241025145539200.png)
...
![20211208161831](Java 面向对象编程.assets/image-20241025145539201.png)
...
![20211208162621](Java 面向对象编程.assets/image-20241025145539202.png)
...
![20231222175003](Java 面向对象编程.assets/image-20241025145539203.png)

如果此时一个项目有上千个接口，就要搭配有上千个工厂类。对开发者而言，是非常绝望的一件事。当然也可以考虑写进一个工厂类里。

![20231222175004](Java 面向对象编程.assets/image-20241025145539204.png)
...
3. Java泛型专题：http://itsoku.com/course/14
...
![20231222175005](Java 面向对象编程.assets/image-20241025145539205.png)
...
![20231222175006](Java 面向对象编程.assets/image-20241025145539206.png)
...
**不是 RuntimeException 或者其子类的异常，编译阶就报错，必须处理，否则代码不通过。**编译时异常示例：

```java
String date = "2020-12-12 12:12:12";
SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
Date d = sdf.parse(date); // 日期解析异常: ParseException, 必须要 try-catch 或者 throws
...
**1、抛出异常**：编译时异常可以通过在方法声明中使用“throws”关键字抛出给调用方，在调用方处进行处理。如果调用方未能捕获该异常，则必须将异常向上抛出，直到被捕获或程序终止。
...
Java 运行时异常是指在程序运行期间发生的异常，它们通常与程序员编写的代码有关，如除以零、数组越界、空指针引用等。与受检异常不同，运行时异常可以不用显式地在方法签名或调用处进行声明或处理。

在 Java 中，运行时异常的处理机制是通过 try-catch 语句来捕获并处理异常。当运行时异常发生时，程序会跳转到与异常匹配的 catch 块中，并执行其中的代码。如果没有匹配的 catch 块，程序会终止并打印出异常信息。
...
在上述示例中，当程序尝试访问索引为3的数组元素时，会发生数组越界异常，抛出 ArrayIndexOutOfBoundsException。由于在 try 块中捕获了该异常，程序会跳转到catch块中，并输出异常信息。

总而言之，Java 提供了 try-catch 语句来捕获和处理运行时异常，程序员可以根据自己的需要选择是否处理这些异常。但应该注意，过多地捕获和处理异常会影响程序的性能和可读性，应该谨慎处理。
...
![20231222175001](Java 面向对象编程.assets/image-20241025145539207.png)
...
![20231222175002](Java 面向对象编程.assets/image-20241025145539208.png)
...
![20211217110130](Java 面向对象编程.assets/image-20241025145539209.png)
...
![20211217111523](Java 面向对象编程.assets/image-20241025145539210.png)
...
1. 继承 Exception：此类异常强制性处理
2. 继承 RuntimeException：此类异常选择性处理
...
3. 【JAVA进阶】异常处理：https://blog.csdn.net/Javascript_tsj/article/details/130857517
4. 异常【ThinkWon】：https://blog.csdn.net/thinkwon/category_9389881.html
...
>
> 升华数组-使用链表灵活整理数据 | 带你学《Java面向对象编程》之八十九：https://developer.aliyun.com/article/741822?spm=a2c6h.12873639.article-detail.9.7da1a441zYQo6s