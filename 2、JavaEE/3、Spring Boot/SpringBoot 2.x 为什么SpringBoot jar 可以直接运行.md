> 为什么SpringBoot的 jar 可以直接运行？：https://mp.weixin.qq.com/s/4eWGz8VYkKojDCKLO1MsJg

# 为什么SpringBoot的 jar 可以直接运行

## 1、spring-boot-maven-plugin 简介 
...
## 4、关于自定义的类加载器 LaunchedURLClassLoader
