...
![image-20210814153349194](Redis-使用教程.assets/image-20241025145538545.png)
...
![image-20210814153349195](Redis-使用教程.assets/image-20241025145538546.png)
...
![20200830123403](Redis-使用教程.assets/image-20241025145538547.png)

下图展示了频道 channel1，已经订阅这个频道的三个客户端。

![20200830123404](Redis-使用教程.assets/image-20241025145538548.png)
...
![image-20210814153349212](Redis-使用教程.assets/image-20241025145538549.png)
...
![image-20210814153349196](Redis-使用教程.assets/image-20241025145538550.png)
...
![image-20210814153349197](Redis-使用教程.assets/image-20241025145538551.png)
...
![image-20210814153349198](Redis-使用教程.assets/image-20241025145538552.png)
...
![image-20210814153349202](Redis-使用教程.assets/image-20241025145538553.png)
...
![image-20210814153349203](Redis-使用教程.assets/image-20241025145538554.png)
...
![image-20210814153349204](Redis-使用教程.assets/image-20241025145538555.png)

![image-20210814153349205](Redis-使用教程.assets/image-20241025145538556.png)
...
![image-20210814153349206](Redis-使用教程.assets/image-20241025145538557.png)
...
![image-20210814153349207](Redis-使用教程.assets/image-20241025145538558.png)
...
![image-20210814153349208](Redis-使用教程.assets/image-20241025145538559.png)
...
![image-20210814153349209](Redis-使用教程.assets/image-20241025145538560.png)
...
![image-20210814153349210](Redis-使用教程.assets/image-20241025145538561.png)
...
![20200830123408](Redis-使用教程.assets/image-20241025235719848.png)

![20200830123409](Redis-使用教程.assets/image-20241025235719849.png)
...
![image-20210814153349211](Redis-使用教程.assets/image-20241025145538562.png)
...
![20210814153351950](Redis-使用教程.assets/image-20241025145538563.png)

### 3、处理命令（Hash一致性算法）

![20210814153351951](Redis-使用教程.assets/image-20241025145538564.png)
...
![20210814153351952](Redis-使用教程.assets/image-20241025145538565.png)
...
![20210814153351953](Redis-使用教程.assets/image-20241025145538566.png)
...
![20210814153351954](Redis-使用教程.assets/image-20241025145538567.png)
...
![20200830123410](Redis-使用教程.assets/image-20241025145538568.png)
...
![20200830123411](Redis-使用教程.assets/image-20241025145538569.png)

2、缓存空对象：当存储层不命中后，即使返回的空对象也将其缓存起来，同步会同步一个过期时间，之后再访问这个数据将会从存储中获取，保护了后端数据源

![20200830123412](Redis-使用教程.assets/image-20241025145538570.png)
...
![20200830123413](Redis-使用教程.assets/image-20241025145538571.png)
...
![20200830123414](Redis-使用教程.assets/image-20241025145538572.png)
